///Config class used to setup better buffering experience or setup custom
///load settings. Currently used only in Android.
class BPBufferingConfig {
  ...
  static const defaultMaxBufferMs = 300000;
