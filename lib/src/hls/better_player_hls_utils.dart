...
class BPHlsUtils {
    ...
    try {
      ...
      if (parsedPlaylist is HlsMasterPlaylist) {
        parsedPlaylist.variants.forEach(
          (variant) {
            tracks.add(BPAsmsTrack('', variant.format.width, variant.format.height, variant.format.bitrate, 0, '', ''));
          },
        );
      }
  ...
  static Future<List<BPAsmsAudioTrack>> parseLanguages(String data, String masterPlaylistUrl) async {
